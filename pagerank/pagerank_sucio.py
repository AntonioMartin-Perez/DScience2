...
def iterate_pagerank(corpus, damping_factor):
    ...
    for page in corpus.keys():
        ...
        # print('suma inicial = ',sum(PageRank.values()))
    # print(PageRank)
    ...
    while delta > tolerance:
        ...
        for page in corpus.keys():
            ...
            New_PageRank[page] = ( (1-damping_factor)/numPag ) + damping_factor * sum_factor
            # print(New_PageRank)
            # print('Nuevos rangos acumulados = ',sum(New_PageRank.values()))
...
# corpus = crawl(".\\corpus0 copy")
# corpus = crawl(".\\corpus0 Testing")
# corpus = crawl(".\\corpus1")
corpus = crawl(".\\corpus2")
# corpus['recursion.html'].add('recursion.html')
# corpus['logic.html'].pop()
...
sample_rank = sample_pagerank(corpus, DAMPING, SAMPLES)
print('sample Rank = ', sample_rank)
print( 'suma =', sum(sample_rank.values()))

iterate_rank = iterate_pagerank(corpus, DAMPING)
print('iterate Rank = ', iterate_rank)
print( 'suma =', sum(iterate_rank.values()))

dif = []
for page in corpus.keys():
    dif.append((abs(sample_rank[page]-iterate_rank[page])))
print(dif)
print(sum(dif))
